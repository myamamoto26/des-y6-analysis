...
def plot_shear_vaiations_ccd(x_side, y_side, ccdres, num_ccd):
    ...
    def stack_CCDs(ccdres, name, x_side, y_side):
        ...
        ax1[1,0].plot(np.arange(1,xbin_num), x_stacked, c='b', label='x-stacked')
        ax1[1,0].errorbar(np.arange(1,xbin_num), x_stacked, yerr=x_stacked_std, c='b')
        ax1[1,0].plot(np.arange(1,ybin_num), y_stacked, c='r', label='y-stacked')
        ax1[1,0].errorbar(np.arange(1,ybin_num), y_stacked, yerr=y_stacked_std, c='r')
        ...
        ax1[1,1].plot(np.arange(1,xbin_num), x_stacked, c='b', label='x-stacked')
        ax1[1,1].errorbar(np.arange(1,xbin_num), x_stacked, yerr=x_stacked_std, c='b')
        ax1[1,1].plot(np.arange(1,xbin_num), y_stacked, c='r', label='y-stacked')
        ax1[1,1].errorbar(np.arange(1,xbin_num), y_stacked, yerr=y_stacked_std, c='r')
