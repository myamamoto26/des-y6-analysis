...
conda activate new-eastlake-dev

#Set up some enviroment variables
export DES_TEST_DATA=/global/project/projectdirs/des/y6-image-sims #you'll need to change this if not working at nersc
export SIM_OUTPUT_DIR=/global/cscratch1/sd/myamamot/imsim/
...
export IMSIM_DATA=${DES_TEST_DATA}
