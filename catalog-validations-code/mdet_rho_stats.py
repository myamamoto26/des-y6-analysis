...
def main(argv):
    ...
    if not os.path.exists(os.path.join('/global/cscratch1/sd/myamamot/metadetect', 'rho_all_JK_griz.json')): 
    ...
    # tau-stats. 
    if not os.path.exists(os.path.join('/global/cscratch1/sd/myamamot/metadetect', 'tau_all_JK_griz.json')): 
