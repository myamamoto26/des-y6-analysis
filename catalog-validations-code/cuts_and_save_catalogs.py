...
def make_cuts_for_gband(argv):
    ...
    for fname in tqdm(mdet_filenames):
        ...
        if mdet_mom == 'pgauss':
            columns = ['slice_id', 'mdet_step', 'ra', 'dec', 'ra_noshear', 'dec_noshear', 'y_noshear', 'x_noshear', 'y', 'x', 'slice_y', 'slice_x', 'slice_y_noshear', 'slice_x_noshear', 'hpix_16384', 'hpix_16384_noshear', 'filename', 'tilename', 'mask_flags', 'mask_flags_noshear', 'nepoch_g','nepoch_eff_g', 'pgauss_flags', 'pgauss_psf_flags', 'pgauss_psf_g_1', 'pgauss_psf_g_2', 'pgauss_psf_T', 'pgauss_obj_flags', 'pgauss_s2n', 'pgauss_g_1', 'pgauss_g_2', 'pgauss_g_cov_1_1', 'pgauss_g_cov_1_2', 'pgauss_g_cov_2_2', 'pgauss_T', 'pgauss_T_flags', 'pgauss_T_err', 'pgauss_T_ratio', 'pgauss_band_flux_flags_g', 'pgauss_band_flux_g', 'pgauss_band_flux_err_g', 'shear_bands', 'ormask', 'mfrac', 'bmask', 'mfrac_img', 'ormask_noshear', 'mfrac_noshear', 'bmask_noshear', 'psfrec_flags', 'psfrec_g_1', 'psfrec_g_2', 'psfrec_T']
